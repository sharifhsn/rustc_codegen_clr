...
use mycorrhiza::system::{console::Console, DotNetString, MString};
...
fn enum_get_name(dow: DayOfWeek) -> DotNetString {
    let m = rustc_clr_interop_generic_method_call1::<
        CORELIB, "System.Enum", false, "GetName", 0, (), (DayOfWeek,),
        (MString, RustcCLRInteropMethodGeneric<0>), MString, DayOfWeek,
    >(dow);
