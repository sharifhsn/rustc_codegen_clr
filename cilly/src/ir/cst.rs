...
impl Const {
    ...
    pub fn is_zero(&self) -> bool {
        match self {
            Const::ByteBuffer { .. } | Const::PlatformString(_) | Const::Bool(_) => false,
            Const::I8(val) => *val == 0,
            Const::I16(val) => *val == 0,
            Const::I32(val) => *val == 0,
            Const::I64(val) | Const::ISize(val) => *val == 0,
            Const::I128(val) => *val == 0,
            Const::U8(val) => *val == 0,
            Const::U16(val) => *val == 0,
            Const::U32(val) => *val == 0,
            Const::U64(val) | Const::USize(val) => *val == 0,
    ...
    pub fn is_one(&self) -> bool {
        match self {
            ...
            Const::I16(val) => *val == 1,
            Const::I32(val) => *val == 1,
            Const::I64(val) | Const::ISize(val) => *val == 1,
            Const::I128(val) => *val == 1,
            Const::U8(val) => *val == 1,
            Const::U16(val) => *val == 1,
            Const::U32(val) => *val == 1,
            Const::U64(val) | Const::USize(val) => *val == 1,
