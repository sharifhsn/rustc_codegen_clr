...
/// Add a field plus its C# nullable-reference contract (`"0"` value/oblivious, `"1"` required
/// reference, `"2"` nullable reference). Generated by the proc macros; the legacy field marker
/// above remains available for hand-written comptime entrypoints.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_nullable_field_def<
    T,
...
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_base_ctor_arg<T, const NULLABILITY: &'static str>(
    class: ClassDef,
) -> ClassDef {
    diverge!()
}
...
/// fields, in declaration order. `VISIBILITY` is one of `"public"`, `"assembly"` (C# `internal`),
/// or `"private"`; the proc macro validates the value before this comptime marker reaches the
/// backend. Assembly visibility lets a Rust-generated static factory construct lifecycle-owned
/// objects without exposing a forgeable constructor to external C# consumers. The backend
/// synthesizes the ctor body; no Rust fn is aliased.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_primary_ctor<const VISIBILITY: &'static str>(
    class: ClassDef,
) -> ClassDef {
    diverge!()
}
...
/// Request getter-only CLR properties backed by the declared fields. The primary constructor is
/// the only generated initialization path; no public setter methods or setter MethodSemantics rows
/// are emitted. This is the metadata shape used by immutable DTO/record projections.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_readonly_field_properties(class: ClassDef) -> ClassDef {
    diverge!()
}

/// Request the conventional CLR value surface for an immutable record-shaped reference type.
///
/// The backend synthesizes field-wise `IEquatable<T>.Equals`, `object.Equals`, `GetHashCode`, a
/// diagnostic `ToString`, `Deconstruct(out ...)`, and `==`/`!=`. Equality and hashing route each
/// field through `EqualityComparer<T>.Default`, so managed nulls, strings, floating-point values,
/// arrays, generated values, and other CLR types follow their own established contracts rather than
/// an incomplete Rust-side imitation.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_record_semantics(class: ClassDef) -> ClassDef {
    diverge!()
}
...
/// Attach a safe structured attribute to the managed method most recently added to this class.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_last_method_custom_attr<const SPEC: &'static str>(
    class: ClassDef,
) -> ClassDef {
    diverge!()
}

/// Attach a safe structured attribute to the return Param (Sequence 0) of the managed method most
/// recently added to this class.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_last_return_custom_attr<const SPEC: &'static str>(
    class: ClassDef,
) -> ClassDef {
    diverge!()
}

/// Attach a safe structured attribute to one zero-based, receiver-stripped managed parameter of
/// the method most recently added to this class.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_last_parameter_custom_attr<
    const INDEX: usize,
...
/// Attach a safe structured attribute to a declared field by source-order index.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_field_custom_attr<
...
/// Attach a safe structured attribute to a generated or interface property by managed name.
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_property_custom_attr<
    const NAME: &'static str,
    const SPEC: &'static str,
>(
    class: ClassDef,
...
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_abstract_method_def<
    const FNAME: &'static str,
    const PARAM_NAMES: &'static str,
    const NULLABILITY: &'static str,
    FnType,
...
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_default_method_def<
    const FNAME: &'static str,
    const PARAM_NAMES: &'static str,
    const NULLABILITY: &'static str,
    FnType,
...
#[allow(unused_variables)]
#[inline(never)]
pub fn rustc_codegen_clr_add_static_abstract_method_def<
    const FNAME: &'static str,
    const PARAM_NAMES: &'static str,
    const NULLABILITY: &'static str,
    FnType,
